  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        >
          <img src={logo} alt="FITZONE" className="h-8 md:h-10 w-auto" />
        </Link>
        ...
        <div className="flex items-center gap-4 lg:gap-6">
          <button
            onClick={toggleCart}
            className="text-primary-text hover:text-luxury-gold transition-colors relative"
          >
            <ShoppingBag size={20} />
            {cartCount > 0 && (
            ...
            >
              <div className="flex justify-between items-center mb-12">
                <Link
                  ...
                  className="hover:opacity-80 transition-opacity block"
                >
                  <img src={logo} alt="FITZONE" className="h-8 w-auto" />
                </Link>
                <button
                  onClick={() => setIsMobileMenuOpen(false)}
              ...
              <div className="mt-auto pt-8 border-t border-black/10 flex gap-6">
                <button onClick={toggleCart} className="text-primary-text hover:text-luxury-gold transition-colors flex items-center gap-2">
                  <ShoppingBag size={20} /> <span className="text-sm">View Cart ({cartCount})</span>
                </button>
              </div>
            </motion.div>
          </>
